...
## Modificaciones
Proyecto autodidacta,debido a la falta de conocimiento respecto a los script y reglas de búsqueda en las tablas GSUB / GPOS, se han eliminado todas las reglas GSUB / GPOS, se han agregado nuevos anclajes, ligaduras y sustituciones. Los cambios están enfocados en las 27 letras del alfabeto español, minúsculas y mayúsculas. Proyecto aún en desarrollo, se estarán añadiendo modificaciones que permitan una conexión fluida sin cortes y enfocado en el estilo manuscrito formal.

## Prueba e Instalación 
Se está probando en la distribución Garuda Mokka y la aplicación LibreOffice Write. Requiere intervención manual en los directorios del sistema.
En distribuciones base Arch, el archivo .ttf se debe mover al directorio "/usr/local/share/fonts/" y luego actualizar la caché de fuentes desde terminal con el comando "fc-cache -fv", eso permitirá aplicar a todo el sistema y que pueda ser reconocido por las aplicaciones. Debido a la amplia cantidad de distribuciones Linux, si utiliza alguna con otra base, buscar la documentación oficial de su distribución para encontrar el directorio correspondiente.
